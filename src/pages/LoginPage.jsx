    ...
    <div className="min-h-full bg-paper-bg p-4 sm:p-8 font-body flex items-center justify-center">
      <div className="w-full max-w-md bg-paper p-8 shadow-lg border-2 border-ink">
        <div className="border-b-2 border-double border-ink pb-4 mb-6 text-center">
          ...
          <div className="text-xs text-ink-muted">FORM AUTH-01 • CREDENTIAL VERIFICATION</div>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs text-ink-muted mb-1 tracking-wider">PASSWORD</label>
          ...
          >
            {loading ? 'VERIFYING...' : 'ACCESS BUREAU'}
          </button>
        </form>
        ...
        <div className="mt-6 pt-4 border-t border-rule text-center">
          <p className="text-xs text-ink-muted font-body">
            No credentials?{' '}
            <Link to="/signup" className="text-ink underline hover:text-ink-red transition">
              Register as new personnel
            </Link>
          </p>
        </div>
        ...
        <div className="mt-4 text-center">
          <div className="text-xs text-ink-faint font-body">
            🔒 Protected by rate limiting • 5 attempts per 15 min
          </div>
        </div>
      </div>
    </div>
